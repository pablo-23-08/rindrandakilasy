...
$pageTitle = 'Étudiant tableau de bord';
?>
...
<nav class="w-64 bg-white border-r flex flex-col">
  ...
  <div class="flex-1 p-4 space-y-2">
    ...
    <a href="<?= $basePath ?>/student/dashboard" class="flex items-center gap-3 p-2 bg-blue-100 rounded">
      <img src="<?= $basePath ?>/assets/img/google-icons/dashboard.svg" alt="Accueil" width="24" height="24">
      Accueil
    </a>

    <a href="<?= $basePath ?>/student/reservations" class="flex items-center gap-3 p-2 hover:bg-gray-100 rounded">
      <img src="<?= $basePath ?>/assets/img/google-icons/event_available.svg" alt="Mes réservations" width="24" height="24">
      Mes réservations
    </a>

    <a href="<?= $basePath ?>/student/new-reservation" class="flex items-center gap-3 p-2 hover:bg-gray-100 rounded">
      <img src="<?= $basePath ?>/assets/img/google-icons/edit_calendar.svg" alt="Faire une réservation" width="24" height="24">
      Faire une réservation
    </a>

    <a href="<?= $basePath ?>/student/profile" class="flex items-center gap-3 p-2 hover:bg-gray-100 rounded">
  ...
  <main class="flex-1 p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="bg-white border rounded p-6 flex flex-col justify-between">
        ...
        <button class="mt-4 bg-blue-600 text-white px-4 py-2 rounded cursor-pointer" onclick="window.location.href='<?= $basePath ?>/student/reservations'">
          Aller
        </button>
      </div>
      ...
      <div class="bg-white border rounded p-6 flex flex-col justify-between">
        ...
        <button class="mt-4 bg-blue-600 text-white px-4 py-2 rounded cursor-pointer" onclick="window.location.href='<?= $basePath ?>/student/new-reservation'">
          Aller
        </button>
      </div>
      ...
      <div class="bg-white border rounded p-6 flex flex-col justify-between">
        ...
        <button class="mt-4 bg-blue-600 text-white px-4 py-2 rounded cursor-pointer" onclick="window.location.href='<?= $basePath ?>/student/profile'">
          Aller
        </button>
      </div>

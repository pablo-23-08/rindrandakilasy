...
<nav class="w-64 bg-white border-r flex flex-col">
  ...
  <div class="flex-1 p-4 space-y-2">
    ...
    <a href="index.php?route=student/profile" class="flex items-center gap-3 p-2 bg-blue-100 rounded">
...
<div class="flex-1 flex flex-col">
  ...
  <main class="flex-1 p-8">
    ...
    <form action="index.php?route=student/profile/update" method="POST" class="max-w-2xl space-y-8">

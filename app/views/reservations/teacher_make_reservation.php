...
// avant une éventuelle erreur de validation (voir ReservationController::storeTeacherReservation).
$old = $old ?? [];
...
<nav class="w-64 bg-white border-r flex flex-col">
  ...
  <div class="flex-1 p-4 space-y-2">
    ...
    <a href="index.php?route=teacher/new-reservation" class="flex items-center gap-3 p-2 bg-blue-100 rounded">
...
<div class="flex-1 flex flex-col">
  ...
  <main class="flex-1 p-8">
    ...
    <form action="index.php?route=teacher/new-reservation/store" method="POST" class="max-w-3xl space-y-8">

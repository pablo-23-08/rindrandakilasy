...
<nav class="w-64 bg-white border-r flex flex-col">
  ...
  <div class="flex-1 p-4 space-y-2">
    ...
    <a href="index.php?route=teacher/reservations" class="flex items-center gap-3 p-2 bg-blue-100 rounded">
  ...
  <main class="flex-1 p-8">
    ...
    <div class="mb-6">
      <form method="GET" action="index.php">
        <input type="hidden" name="route" value="teacher/reservations">
              ...
              <tr>
                ...
                <td class="border px-4 py-2 text-center">
                  <?php if (Reservation::isCancellable($reservation['status'])): ?>
                    <form method="POST" action="index.php?route=teacher/reservations/cancel"
